...
module titleblock1(fill = true)
{
    ...
    details = [[cols [0] + desc_x, rows [0] + det_y, DIM_HORZ, "SCADY", 1],      // Responsible dep.
               [cols [1] + desc_x, rows [0] + det_y, DIM_HORZ, "SAMP-DS", 1],    // Technical reference
               [cols [2] + desc_x, rows [0] + det_y, DIM_HORZ, "D. Smiley ", 1], // Creator
               [cols [3] + desc_x, rows [0] + det_y, DIM_HORZ, "C. Brooks ", 1], // Approval person
               [cols [0] + desc_x + 10, rows [2] + det_y, DIM_HORZ, "My OpenSCAD Project", 1],
               [cols [2] + desc_x, rows [1] + det_y, DIM_HORZ, ".scad", 1],       // Document type
               ...
               [cols [3] + desc_x, rows [3] + det_y, DIM_HORZ, "B", 1],           // Rev
